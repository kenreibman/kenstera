    ...
    <section className="bg-white text-black">
      <div className="mx-auto max-w-6xl px-3 sm:px-6 py-12 lg:py-16">
        <div className="mx-auto max-w-5xl text-center">
          <h1 className="text-balance font-medium leading-[1.05] tracking-[-0.02em] text-3xl sm:text-5xl text-center">
            The agency that delivers results
          </h1>

          <p className="mx-auto mt-6 max-w-3xl text-center text-balance sm:text-pretty text-lg leading-6 text-black/70 sm:text-lg sm:leading-7">
